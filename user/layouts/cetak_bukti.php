...
<head>
  ...
  <title>PPDB SEKOLAH ISLAM BINA INSANI</title>
          ...
          <div class="box box-widget widget-user-2">
            ...
            <?php foreach($terima as $trm) : ?>
              <ul class="nav nav-stacked">
                    ...
                    <li><a href="#">Nama Orant Tua <span class="direct-chat-text bg-teal"><i class="fa fa-university"></i> <?php echo $trm['nama_ortu'] ?></span></a></li>
